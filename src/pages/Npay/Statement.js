...
const Statement = () => {
  return (
    <div className="npay-statement">
      <h4>Statement</h4>
      <p>
        The Nigerian bills payments system is rigid and vastly manual, there has been a pressing need to digitalize and simply the payment process for citizens. <br />
